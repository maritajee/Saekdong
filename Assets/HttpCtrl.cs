...
public class HttpCtrl : MonoBehaviour
{
    ...
    public void GetObject()
    {
        ...
        for (int i = 0; i < 6; i++)
        {
            ...
            {
                if (Shapes[j].name == sticks.Items[sticks.Items.Length - 6 + i].object1 + "_Onstick")
                {
                    temp1 = Shapes[j];
                }
                if (Shapes[j].name == sticks.Items[sticks.Items.Length - 6 + i].object2 + "_Onstick")
                {
                    temp2 = Shapes[j];
                }
                if (Shapes[j].name == sticks.Items[sticks.Items.Length - 6 + i].object3 + "_Onstick")
                {
                    temp3 = Shapes[j];
                }
